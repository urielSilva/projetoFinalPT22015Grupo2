...
# Create users
User.create(name: "Gabriel", last_name: "Almeida", email: "gabrielalmeida@cjr.org.br", password: "almeida123", user_status_id: 1, job_id: 5, sector_id: 1, profile_id: 2)
User.create(name: "Bruno", last_name: "Oliveira", email: "brunooliveira@cjr.org.br", password: "oliveira123", user_status_id: 1, job_id: 5, sector_id: 2, profile_id: 2)
User.create(name: "Rafael", last_name: "Fernandes", email: "rafaelalves@cjr.org.br", password: "fernandes123", user_status_id: 1, job_id: 5, sector_id: 3, profile_id: 2)
User.create(name: "Anne", last_name: "Carolina", email: "annecarolina@cjr.org.br", password: "carolina123", user_status_id: 1, job_id: 5, sector_id: 4, profile_id: 2)
User.create(name: "Gabriel", last_name: "Mesquita", email: "gabrielmesquita@cjr.org.br", password: "mesquita123", user_status_id: 1, job_id: 5, sector_id: 5, profile_id: 2)

class KnowledgesController < ApplicationController
    ...
    def update
    	respond_to do |format|
    		if @knowledge.update(knowledge_params)
    			format.html { redirect_to @knowledge, notice: 'Knowledge was succesfully formated' }
    ...
    def destroy 
    	@knowledge.destroy
    	respond_to do |format|
    		format.html { redirect_to knowledges_url, notice: 'Knowledge was succesfully destroyed' }
    ...
    private
    	...
    	def knowledge_params
    		params.require(:knowledge).permit(:knowledge_level_id, :description)
    	end
end
